...
<head>
    ...
    <meta name="keywords" content=" web design in ilorin, web design in ibadan,web design in lagos, website in Nigeria,webdesign in Nigeria,  web development, E-commerce, wordpress, freelance developer, blog">
    <meta property="og:title" content="The number one naija blog for the latest sports and current news">
    <meta property="og:description" content="Home of all sports news and world current news">
    <meta property="og:image" content="https://unitechdev.com/image/ogimage.jpg">
    <meta property="og:url" content="https://unitechdev.com">
    <meta propery="og:type" content="blog">
    <meta property="twitter:title" content="The number one for the latest sports and current news">
    <meta property="twitter:description" content="The number one naija blog for the latest sports and current news">
...
<body>
                        ...
                        <div class="swiper-container swipe1">
                            ...
                            <div class="swiper-slide">
                              <a href="public/viewpost.php?vid=<?php echo $result['id'];?>"><img src="<?= $explode[1];?>" alt="sliding image" class="img-fluid card-img-top">
                        ...
                        <div class="col-md-6">
                                    ...
                                    <div>
                                        <img src="<?=$explode[1];?>" alt="blog post image" class="card-img-top">
                                                ...
                                                <div class="card body p-2">
                                                    ...
                                                    <a href="public/viewpost.php?vid=<?php echo $result['id'];?>" class="btn btn-primary btn-sm">Read More</a>
                                                </div>
                                                </div>
                                        <?php } ?>
                                        <!--view all button-->
                                        <div class="text-center py-4" id="view">
                                             <a href="public/latest.php"><button>View all</button></a>
                                         </div>
                                         </div>
                             ...
                             <div class="col-md-4">
                                <div class="list-group">
                                    ...
                                    <a href="public/latest.php" class="list-group-item">Latest Posts</a>
                                    <a href="public/popular.php" class="list-group-item primary">Popular Posts</a>
                                    <a href="public/politics.php" class="list-group-item primary">Politics</a>
                                    <a href="public/education.php" class="list-group-item primary">Education</a>
                                    <a href="public/sports.php" class="list-group-item">Sports </a>
                                    <a href="public/othernews.php" class="list-group-item">Other News </a>
                                </div>             
