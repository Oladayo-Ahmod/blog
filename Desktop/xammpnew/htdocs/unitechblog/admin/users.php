                                            ...
                                            while($array = $process->fetch_array()){?>
                                                <tr>
                                                    ...
                                                    <td style="display: flex;">
                                                        ...
                                                        <a style="color:white;text-decoration:none;" href="edituser.php?uid=<?php echo $array['id'];?>">Edit</a>
                                                        </button>
                                                        <button class="btn btn-danger" name="delete">
                                                        <a style="color:white;text-decoration:none;" href="deleteuser.php?uid=<?php echo $array['id'];?>">Delete
                                                        </a>
                                                        </button>
