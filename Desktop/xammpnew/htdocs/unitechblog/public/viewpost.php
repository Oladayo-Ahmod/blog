...
<body>
        ...
        <div class="swiper-container swipe1">
                            ...
                            <div class="swiper-slide">
                              <a href="public/viewpost.php?vid=<?php echo $result['id'];?>"><img src="<?php echo $result['image_dir'];?>" class="img-fluid card-img-top" alt="sliding image"></a>
        ...
        <section id="section">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h1 class="card-title"><?php echo $fetch['post_title'];?></h1>
                        <div class="card shadow">
                            <div>
                                <img src="<?= $fetch['image_dir'];?>" class="img-fluid card-img-top" alt="post image">
                            </div>
                            <div class="card-body">
                                <h3 class="card-title"><?php echo strip_tags($fetch['post_desc']);?></h3>
                                <small class="text-left;"><span class="fas fa-clock text-primary "></span> <?php echo $fetch['post_date'];?></small><br>
                                <small class="text-right"><i>Posted by</i> <?php echo $fetch['post_author'];?></small>
                            </div>
                            <div class="p-2">
