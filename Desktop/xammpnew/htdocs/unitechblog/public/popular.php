...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="<?php echo 'Just in! buhari resigns as nigeria president amisdt lock down'?>">
...
<body>
                        ...
                        <div class="swiper-container swipe1">
                            ...
                            <div class="swiper-slide">
                              <a href="public/viewpost.php?vid=<?php echo $result['id'];?>"><img src="<?= $result['image_dir']?>" alt="sliding image" class="img-fluid card-img-top">
