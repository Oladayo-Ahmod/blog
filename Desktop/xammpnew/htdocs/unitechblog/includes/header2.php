<section id="navbar">
		...
		<div class="container">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link" href="pages.php"><i class="fa fa-file-word text-primary mr-1"></i>Pages</a></li>
				<li class="nav-item"><a class="nav-link" href="profile.php?mprid=<?=$id;?>"><i class="fas fa-user-circle mr-1 text-primary"></i>Profile</a></li>
         	</ul>
